...
инструмент спрашивает секрет сам. Файл секрета обязан быть недоступен группе и
остальным (`chmod 600`) — иначе отказ до чтения содержимого. Флага, принимающего
секрет **значением**, не существует: аргументы видны в списке процессов.

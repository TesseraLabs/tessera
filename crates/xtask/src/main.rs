...
fn main() -> std::process::ExitCode {
    ...
    let outcome = match &cli.command {
        ...
        cli::Command::CodesSignChallenge(args) => codes_sign::codes_sign_challenge(args),
        cli::Command::CodesSignRequest(args) => codes_sign::codes_sign_request(args),
        cli::Command::CodesStandFixtures(args) => codes_stand::codes_stand_fixtures(args),

...
На них ссылается кейсов: 42. Именно на столько сумма по таблицам выше меньше числа кейсов в сводке: строки в тех таблицах эти спеки получат, когда переедут в `openspec/specs/`.

| Спека | Предложение | Кейсов |
|---|---|---:|
| issuance-request | engineer-issuance-tooling | 14 |

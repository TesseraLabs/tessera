...
- Явный выбор роли на логине: инженер входит в ролевую учётную запись,
  названную по роли (`ssh oper@device`), дефолтной роли нет; вход
  авторизуется расширением `pam_cert_allowed_roles`.
...
Полный пошаговый сценарий — в [docs/ru/install.md](docs/ru/install.md).
...
прочитать [docs/ru/install.md §8](docs/ru/install.md) и
[docs/ru/operations.md §3.6](docs/ru/operations.md) — потеря или блокировка
...
9. Подключить модуль к `sudo` в режиме 2FA (по умолчанию):
   ...
   `docs/ru/install.md §8` и `docs/ru/operations.md §3.6`).
...
- [docs/ru/index.md](docs/ru/index.md) — оглавление документации.
- [docs/ru/install.md](docs/ru/install.md) — пошаговая установка.
- [docs/ru/configuration.md](docs/ru/configuration.md) — справочник по `config.toml`.
- [docs/ru/cert-issuance.md](docs/ru/cert-issuance.md) — выпуск сертификатов с расширениями.
- [docs/ru/architecture.md](docs/ru/architecture.md) — архитектура и IPC.
- [docs/ru/threat-model.md](docs/ru/threat-model.md) — модель угроз.
- [docs/ru/operations.md](docs/ru/operations.md) — runbook эксплуатации.
- [docs/ru/development.md](docs/ru/development.md) — гид контрибьютора.
- [docs/ru/changelog.md](docs/ru/changelog.md) — история изменений.

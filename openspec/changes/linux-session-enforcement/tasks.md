...
- [ ] 4.3 `docs/architecture.md` — раздел enforcement приводится в соответствие; раздел `terminal-deployment.md` (роли oper/serv) публикуется как рабочий после реализации

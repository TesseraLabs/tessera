...
- [x] 3.4 МООТ: целевой change `cabinet-inventory-tab-and-persistence` не существует (поглощён переносом кабинета в tessera-enterprise) — правкой заниматься негде; правка терминологии в живых артефактах покрыта задачей 1.4
